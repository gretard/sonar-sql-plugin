...
public enum MySQLRules {
    ...
    protected Rule getColumnListRule() {
        ...
        parent.getNames()
                .getTextItem()
                .add(
                        org.antlr.sql.dialects.mysql.MySqlParser.FullColumnNameContext.class
                                .getSimpleName());
        ...
        // filter only select columns
        {
            ...
            querySpec
                    ...
                    .getTextItem()
                    .add(
                            org.antlr.sql.dialects.mysql.MySqlParser.SelectColumnElementContext
                                    .class
                                    .getSimpleName());
        ...
        }
        {
            ...
            columnRefCheck
                    ...
                    .getTextItem()
                    .add(
                            org.antlr.sql.dialects.mysql.MySqlParser.DottedIdContext.class
                                    .getSimpleName());
        ...
        }
        {
            ...
            querySpec
                    ...
                    .getTextItem()
                    .add(
                            org.antlr.sql.dialects.mysql.MySqlParser.DmlStatementContext.class
                                    .getSimpleName());
            querySpec.setRuleMatchType(RuleMatchType.CLASS_ONLY);
            ...
            fromClauseSpec
                    ...
                    .getTextItem()
                    .add(
                            org.antlr.sql.dialects.mysql.MySqlParser.FromClauseContext.class
                                    .getSimpleName());
            ...
            tableRefs
                    ...
                    .getTextItem()
                    .add(
                            org.antlr.sql.dialects.mysql.MySqlParser.AtomTableItemContext.class
                                    .getSimpleName());
    ...
    protected Rule getCartesianJoinsRule() {
        ...
        child.getNames()
                .getTextItem()
                .add(
                        org.antlr.sql.dialects.mysql.MySqlParser.TableSourceBaseContext.class
                                .getSimpleName());
    ...
    protected Rule getExistsVsInRule() {
        ...
        childSubqueryContext
                .getNames()
                .getTextItem()
                .add(QuerySpecificationContext.class.getSimpleName());
    ...
    protected Rule getSargRule() {
        ...
        ruleFunctionCall
                .getNames()
                .getTextItem()
                .add(ScalarFunctionCallContext.class.getSimpleName());
        ...
        predicateContextContainsLike
                .getNames()
                .getTextItem()
                .add(LikePredicateContext.class.getSimpleName());
