    ...
    public static void main(String[] args) {
        ...
        for (SqlRules rule : rules) {
            ...
            for (Rule r : rule.getRule()) {
                ...
                r.getRuleImplementation().getCompliantRulesCodeExamples().getRuleCodeExample().forEach(line -> {
                    sb.append(line);
                    sb.append("\r\n");
                    sb.append(line);
                    sb.append("\r\n");
                ...
                r.getRuleImplementation().getViolatingRulesCodeExamples().getRuleCodeExample().forEach(line -> {
                    sb.append(line);
                    sb.append("\r\n");
                    sb.append(line);
                    sb.append("\r\n");
